...
namespace PavelVasilyev\AuthAjax\View\Components\Layouts;
...
class Modal extends Component
{
    ...
    public function __construct(Request $request, $pgTitle=null)
    {
    ...
    public function render()
    {
        ...
        return view('auth-ajax::components.layouts.modal', $this->modal);
    }
}
